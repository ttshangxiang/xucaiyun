...
export class Comment7 extends LitElement {
  ...
  replyIt (replyId: string, replyTo: string, showReply = false) {
    ...
    document.scrollingElement && (document.scrollingElement.scrollTop = height);
    document.documentElement && (document.documentElement.scrollTop = height);
    this.$message.focus();
  }
    ...
    return html `
      ...
      <div class="message" .style=${this.maxw ? 'max-width: ' + this.maxw + 'px;' : ''}>
        ...
        <div class="post card">
          ...
          ${this.replyParam.id ? html `
            <div class="input-reply-to">回复@${this.replyParam.to}：</div>
          ` : ''}
          <div class="input-item">
            ...
            <div class="input-right">
              ...
              ${this.replyParam.id ? html `
              <a href="javascript:;" class="cancel-btn" @click=${this.resetReply}>清除回复对象</a>
              ` : ''}
            </div>
          </div>
        </div>
